...
All 16 diagrams in this group, drawn inline.
...
| 02 | [Key feature flow — Order export](#d-02) | `flowchart` | [modules/integration](/docs/modules/integration) |
| 03 | [Key feature flow — Report run](#d-03) | `flowchart` | [modules/report](/docs/modules/report) |
| 04 | [Approval flow](#d-04) | `flowchart` | [modules/payment](/docs/modules/payment) |
| 05 | [Key feature flow — SMS dispatch](#d-05) | `sequence` | [modules/sms](/docs/modules/sms) |
| 06 | [Key feature flow — Stocktake](#d-06) | `flowchart` | [modules/inventory](/docs/modules/inventory) |
| 07 | [Key feature flow — Submission](#d-07) | `flowchart` | [modules/audit-adt](/docs/modules/audit-adt) |
| 08 | [Domain entities](#d-08) | `er` | [modules/audit-adt](/docs/modules/audit-adt) |
| 09 | [Workflow 1.1 — Photo-report capture and review](#d-09) | `sequence` | [modules/audit-adt](/docs/modules/audit-adt) |
| 10 | [Workflow 1.2 — Storecheck (MML) compliance check](#d-10) | `flowchart` | [modules/audit-adt](/docs/modules/audit-adt) |
| 11 | [Key feature flow — Goods receipt](#d-11) | `flowchart` | [modules/warehouse](/docs/modules/warehouse) |
| 12 | [Key feature flow — Online order](#d-12) | `flowchart` | [modules/onlineOrder](/docs/modules/onlineOrder) |
| 13 | [Status machine](#d-13) | `state` | [modules/orders](/docs/modules/orders) |
| 14 | [Key feature flow — Create order](#d-14) | `sequence` | [modules/orders](/docs/modules/orders) |
| 15 | [Key feature flow — Visit & GPS](#d-15) | `flowchart` | [modules/agents](/docs/modules/agents) |
| 16 | [Key feature flow — Defect & Return](#d-16) | `flowchart` | [modules/stock](/docs/modules/stock) |
...
## 02. Key feature flow — Order export {#d-02}
...
## 03. Key feature flow — Report run {#d-03}
...
## 05. Key feature flow — SMS dispatch {#d-05}

- **Kind**: `sequence`
- **Source page**: [modules/sms](/docs/modules/sms)
- **Originating section**: Key feature flow — SMS dispatch
...
## 06. Key feature flow — Stocktake {#d-06}
...
## 07. Key feature flow — Submission {#d-07}
...
## 09. Workflow 1.1 — Photo-report capture and review {#d-09}
...
## 10. Workflow 1.2 — Storecheck (MML) compliance check {#d-10}
...
## 11. Key feature flow — Goods receipt {#d-11}
...
## 12. Key feature flow — Online order {#d-12}
...
## 14. Key feature flow — Create order {#d-14}
...
## 15. Key feature flow — Visit & GPS {#d-15}
...
## 16. Key feature flow — Defect & Return {#d-16}
