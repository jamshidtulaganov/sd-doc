---
sidebar_position: 4
title: "sd-main · System design"
audience: All team members
summary: "Tier-level architecture of sd-main — HTTP, app tier, MySQL, Redis (3 DBs), queue, cron, file storage."
topics: [diagrams, sd, main, system]
---

# sd-main · System design — diagram gallery
...
|---|-------|------|-------------|
| 01 | [Topology overview](#d-01) | `flowchart` | [devops/deployment](/docs/devops/deployment) |
| 02 | [High-level diagram](#d-02) | `flowchart` | [architecture/overview](/docs/architecture/overview) |
| 03 | [1. Topology](#d-03) | `flowchart` | [architecture/cross-project-integration](/docs/architecture/cross-project-integration) |
| 04 | [2.3 Sequence — licence push (most common)](#d-04) | `sequence` | [architecture/cross-project-integration](/docs/architecture/cross-project-integration) |
...
- **Kind**: `flowchart`
- **Source page**: [devops/deployment](/docs/devops/deployment)
- **Originating section**: Topology overview
...
## 02. High-level diagram {#d-02}

- **Kind**: `flowchart`
- **Source page**: [architecture/overview](/docs/architecture/overview)
- **Originating section**: High-level diagram
...
- **Originating section**: 1. Topology
...
## 04. 2.3 Sequence — licence push (most common) {#d-04}

- **Kind**: `sequence`
- **Source page**: [architecture/cross-project-integration](/docs/architecture/cross-project-integration)
- **Originating section**: 2.3 Sequence — licence push (most common)
...
## 05. 3.2 buyPackages — the canonical path {#d-05}

- **Kind**: `sequence`
- **Source page**: [architecture/cross-project-integration](/docs/architecture/cross-project-integration)
- **Originating section**: 3.2 buyPackages — the canonical path
...
## 06. 4.4 Sequence — cross-dealer report {#d-06}

- **Kind**: `sequence`
- **Source page**: [architecture/cross-project-integration](/docs/architecture/cross-project-integration)
- **Originating section**: 4.4 Sequence — cross-dealer report
...
## 07. 6. Provisioning a new dealer (end-to-end) {#d-07}

- **Kind**: `flowchart`
- **Source page**: [architecture/cross-project-integration](/docs/architecture/cross-project-integration)
- **Originating section**: 6. Provisioning a new dealer (end-to-end)
