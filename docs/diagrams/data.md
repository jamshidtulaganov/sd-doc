...
summary: "Two ERDs side-by-side: the conceptual intent and the truth-from-the-code (generated from declared Yii relations)."
topics: [diagrams, data]
---

# Data · ERDs — diagram gallery

Two ERDs side-by-side: the conceptual intent and the truth-from-the-code (generated from declared Yii relations).

All 2 diagrams in this group, drawn inline.

## Index

| # | Title | Kind | Source page |
|---|-------|------|-------------|
| 01 | [Entity-relationship diagram](#d-01) | `er` | [data/erd](/docs/data/erd) |
| 02 | [Mermaid (full graph)](#d-02) | `er` | [data/erd-real](/docs/data/erd-real) |

## 01. Entity-relationship diagram {#d-01}

- **Kind**: `er`
- **Source page**: [data/erd](/docs/data/erd)
- **Originating section**: Entity-relationship diagram
...
## 02. Mermaid (full graph) {#d-02}

- **Kind**: `er`
- **Source page**: [data/erd-real](/docs/data/erd-real)
- **Originating section**: Mermaid (full graph)
