...
summary: "Three-project map of the SalesDoctor platform. Use these diagrams to orient new hires before they dive into any single project."
topics: [diagrams, ecosystem]
---

# Ecosystem — diagram gallery

Three-project map of the SalesDoctor platform. Use these diagrams to orient new hires before they dive into any single project.
...
|---|-------|------|-------------|
| 01 | [The SalesDoctor ecosystem](#d-01) | `flowchart` | [ecosystem](/docs/ecosystem) |
| 02 | [Inter-project integration map](#d-02) | `flowchart` | [ecosystem](/docs/ecosystem) |
| 03 | [Key feature catalog by project](#d-03) | `flowchart` | [ecosystem](/docs/ecosystem) |

## 01. The SalesDoctor ecosystem {#d-01}

- **Kind**: `flowchart`
- **Source page**: [ecosystem](/docs/ecosystem)
- **Originating section**: The SalesDoctor ecosystem
...
## 02. Inter-project integration map {#d-02}

- **Kind**: `flowchart`
- **Source page**: [ecosystem](/docs/ecosystem)
- **Originating section**: Inter-project integration map
...
## 03. Key feature catalog by project {#d-03}

- **Kind**: `flowchart`
- **Source page**: [ecosystem](/docs/ecosystem)
- **Originating section**: Key feature catalog by project
