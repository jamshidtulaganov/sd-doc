...
summary: "Obuna hisob-kitobi — litsenziyalash, to'lovlar (Click/Payme/Paynet/MBANK), distribyutor settlement, dunning."
topics: [diagrams, sd, billing]
---

# sd-billing — diagramma galereyasi

Obuna hisob-kitobi — litsenziyalash, to'lovlar (Click/Payme/Paynet/MBANK),
distribyutor settlement, dunning.

Ushbu guruhdagi 12 ta diagrammaning hammasi ichki ko'rinishda chizilgan.

## Indeks

| # | Sarlavha | Tur | Manba sahifa |
|---|-------|------|-------------|
| 01 | [5. Navbatni bo'shatish — `cron.php notify`](#d-01) | `sequence` | [sd-billing/notifications](/docs/sd-billing/notifications) |
| 02 | [Arxitektura diagrammasi](#d-02) | `flowchart` | [sd-billing/overview](/docs/sd-billing/overview) |
| 03 | [sd-main va sd-cs bilan integratsiya](#d-03) | `sequence` | [sd-billing/integration](/docs/sd-billing/integration) |
| 04 | [sd-billing domen modeli](#d-04) | `er` | [sd-billing/domain-model](/docs/sd-billing/domain-model) |
| 05 | [Ketma-ketlik](#d-05) | `sequence` | [sd-billing/balance-and-money-math](/docs/sd-billing/balance-and-money-math) |
| 06 | [Balans o'zgarishlardan keyin — litsenziyani yangilash](#d-06) | `flowchart` | [sd-billing/balance-and-money-math](/docs/sd-billing/balance-and-money-math) |
| 07 | [Obuna va litsenziyalash](#d-07) | `flowchart` | [sd-billing/subscription-flow](/docs/sd-billing/subscription-flow) |
| 08 | [ERD (shakl ko'rinishi)](#d-08) | `er` | [sd-billing/data-scheme](/docs/sd-billing/data-scheme) |
| 09 | [Settlement](#d-09) | `flowchart` | [sd-billing/cron-and-settlement](/docs/sd-billing/cron-and-settlement) |
| 10 | [Bildirishnomalar cron](#d-10) | `sequence` | [sd-billing/cron-and-settlement](/docs/sd-billing/cron-and-settlement) |
| 11 | [Click oqimi (kanonik)](#d-11) | `sequence` | [sd-billing/payment-gateways](/docs/sd-billing/payment-gateways) |
| 12 | [Payme oqimi](#d-12) | `sequence` | [sd-billing/payment-gateways](/docs/sd-billing/payment-gateways) |

## 01. 5. Navbatni bo'shatish — `cron.php notify` {#d-01}

- **Turi**: `sequence`
- **Manba sahifa**: [sd-billing/notifications](/docs/sd-billing/notifications)
- **Boshlovchi bo'lim**: 5. Navbatni bo'shatish — `cron.php notify`
...
## 02. Arxitektura diagrammasi {#d-02}

- **Turi**: `flowchart`
- **Manba sahifa**: [sd-billing/overview](/docs/sd-billing/overview)
- **Boshlovchi bo'lim**: Arxitektura diagrammasi
...
## 03. sd-main va sd-cs bilan integratsiya {#d-03}

- **Turi**: `sequence`
- **Manba sahifa**: [sd-billing/integration](/docs/sd-billing/integration)
- **Boshlovchi bo'lim**: sd-main va sd-cs bilan integratsiya
...
## 04. sd-billing domen modeli {#d-04}

- **Turi**: `er`
- **Manba sahifa**: [sd-billing/domain-model](/docs/sd-billing/domain-model)
- **Boshlovchi bo'lim**: sd-billing domen modeli
...
## 05. Ketma-ketlik {#d-05}

- **Turi**: `sequence`
- **Manba sahifa**: [sd-billing/balance-and-money-math](/docs/sd-billing/balance-and-money-math)
- **Boshlovchi bo'lim**: Ketma-ketlik
...
## 06. Balans o'zgarishlardan keyin — litsenziyani yangilash {#d-06}

- **Turi**: `flowchart`
- **Manba sahifa**: [sd-billing/balance-and-money-math](/docs/sd-billing/balance-and-money-math)
- **Boshlovchi bo'lim**: Balans o'zgarishlardan keyin — litsenziyani yangilash
...
## 07. Obuna va litsenziyalash {#d-07}

- **Turi**: `flowchart`
- **Manba sahifa**: [sd-billing/subscription-flow](/docs/sd-billing/subscription-flow)
- **Boshlovchi bo'lim**: Obuna va litsenziyalash
...
## 08. ERD (shakl ko'rinishi) {#d-08}

- **Turi**: `er`
- **Manba sahifa**: [sd-billing/data-scheme](/docs/sd-billing/data-scheme)
- **Boshlovchi bo'lim**: ERD (shakl ko'rinishi)
...
- **Turi**: `flowchart`
- **Manba sahifa**: [sd-billing/cron-and-settlement](/docs/sd-billing/cron-and-settlement)
- **Boshlovchi bo'lim**: Settlement
...
## 10. Bildirishnomalar cron {#d-10}

- **Turi**: `sequence`
- **Manba sahifa**: [sd-billing/cron-and-settlement](/docs/sd-billing/cron-and-settlement)
- **Boshlovchi bo'lim**: Bildirishnomalar cron
...
## 11. Click oqimi (kanonik) {#d-11}

- **Turi**: `sequence`
- **Manba sahifa**: [sd-billing/payment-gateways](/docs/sd-billing/payment-gateways)
- **Boshlovchi bo'lim**: Click oqimi (kanonik)
