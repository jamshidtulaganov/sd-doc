...
summary: "SalesDoctor platformasining uchta loyihali xaritasi. Yangi xodimlarni biron bitta loyihaga sho'ng'ishidan oldin yo'naltirish uchun ushbu diagrammalarni ishlating."
topics: [diagrams, ecosystem]
---

# Ekotizim — diagramma galereyasi

SalesDoctor platformasining uchta loyihali xaritasi. Yangi xodimlarni biron
bitta loyihaga sho'ng'ishidan oldin yo'naltirish uchun ushbu diagrammalarni
ishlating.
...
|---|-------|------|-------------|
| 01 | [SalesDoctor ekotizimi](#d-01) | `flowchart` | [ecosystem](/docs/ecosystem) |
| 02 | [Loyihalararo integratsiya xaritasi](#d-02) | `flowchart` | [ecosystem](/docs/ecosystem) |
| 03 | [Loyiha bo'yicha asosiy xususiyatlar katalogi](#d-03) | `flowchart` | [ecosystem](/docs/ecosystem) |

## 01. SalesDoctor ekotizimi {#d-01}

- **Turi**: `flowchart`
- **Manba sahifa**: [ecosystem](/docs/ecosystem)
- **Boshlovchi bo'lim**: SalesDoctor ekotizimi
...
## 02. Loyihalararo integratsiya xaritasi {#d-02}

- **Turi**: `flowchart`
- **Manba sahifa**: [ecosystem](/docs/ecosystem)
- **Boshlovchi bo'lim**: Loyihalararo integratsiya xaritasi
...
## 03. Loyiha bo'yicha asosiy xususiyatlar katalogi {#d-03}

- **Turi**: `flowchart`
- **Manba sahifa**: [ecosystem](/docs/ecosystem)
- **Boshlovchi bo'lim**: Loyiha bo'yicha asosiy xususiyatlar katalogi
