---
sidebar_position: 5
title: "Ma'lumotlar · ERD lar"
audience: Jamoaning barcha a'zolari
summary: "Yonma-yon ikkita ERD: konseptual maqsad va koddan haqiqat (e'lon qilingan Yii munosabatlaridan generatsiya qilingan)."
topics: [diagrams, data]
---

# Ma'lumotlar · ERD lar — diagramma galereyasi

Yonma-yon ikkita ERD: konseptual maqsad va koddan haqiqat (e'lon qilingan
Yii munosabatlaridan generatsiya qilingan).

Ushbu guruhdagi 2 ta diagrammaning hammasi ichki ko'rinishda chizilgan.

## Indeks

| # | Sarlavha | Tur | Manba sahifa |
|---|-------|------|-------------|
| 01 | [Mavjudot-munosabat diagrammasi](#d-01) | `er` | [data/erd](/docs/data/erd) |
| 02 | [Mermaid (to'liq graf)](#d-02) | `er` | [data/erd-real](/docs/data/erd-real) |

## 01. Mavjudot-munosabat diagrammasi {#d-01}

- **Turi**: `er`
- **Manba sahifa**: [data/erd](/docs/data/erd)
- **Boshlovchi bo'lim**: Mavjudot-munosabat diagrammasi
...
## 02. Mermaid (to'liq graf) {#d-02}

- **Turi**: `er`
- **Manba sahifa**: [data/erd-real](/docs/data/erd-real)
- **Boshlovchi bo'lim**: Mermaid (to'liq graf)
