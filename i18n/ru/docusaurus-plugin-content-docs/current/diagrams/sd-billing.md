...
summary: "Биллинг подписок — лицензирование, платежи (Click/Payme/Paynet/MBANK), расчёты с дистрибьюторами, dunning."
topics: [diagrams, sd, billing]
---

# sd-billing — галерея диаграмм

Биллинг подписок — лицензирование, платежи (Click/Payme/Paynet/MBANK), расчёты с дистрибьюторами, dunning.

Все 12 диаграмм группы, отрисованные inline.

## Указатель

| # | Заголовок | Тип | Исходная страница |
|---|-------|------|-------------|
| 01 | [5. Дренаж очереди — `cron.php notify`](#d-01) | `sequence` | [sd-billing/notifications](/docs/sd-billing/notifications) |
| 02 | [Диаграмма архитектуры](#d-02) | `flowchart` | [sd-billing/overview](/docs/sd-billing/overview) |
| 03 | [Интеграция с sd-main и sd-cs](#d-03) | `sequence` | [sd-billing/integration](/docs/sd-billing/integration) |
| 04 | [Доменная модель sd-billing](#d-04) | `er` | [sd-billing/domain-model](/docs/sd-billing/domain-model) |
| 05 | [Sequence](#d-05) | `sequence` | [sd-billing/balance-and-money-math](/docs/sd-billing/balance-and-money-math) |
| 06 | [После изменения баланса — обновление лицензии](#d-06) | `flowchart` | [sd-billing/balance-and-money-math](/docs/sd-billing/balance-and-money-math) |
| 07 | [Подписка и лицензирование](#d-07) | `flowchart` | [sd-billing/subscription-flow](/docs/sd-billing/subscription-flow) |
| 08 | [ERD (вид по форме)](#d-08) | `er` | [sd-billing/data-scheme](/docs/sd-billing/data-scheme) |
| 09 | [Расчёты](#d-09) | `flowchart` | [sd-billing/cron-and-settlement](/docs/sd-billing/cron-and-settlement) |
| 10 | [Cron уведомлений](#d-10) | `sequence` | [sd-billing/cron-and-settlement](/docs/sd-billing/cron-and-settlement) |
| 11 | [Поток Click (каноничный)](#d-11) | `sequence` | [sd-billing/payment-gateways](/docs/sd-billing/payment-gateways) |
| 12 | [Поток Payme](#d-12) | `sequence` | [sd-billing/payment-gateways](/docs/sd-billing/payment-gateways) |

## 01. 5. Дренаж очереди — `cron.php notify` {#d-01}

- **Тип**: `sequence`
- **Исходная страница**: [sd-billing/notifications](/docs/sd-billing/notifications)
- **Раздел-источник**: 5. Дренаж очереди — `cron.php notify`
...
## 02. Диаграмма архитектуры {#d-02}

- **Тип**: `flowchart`
- **Исходная страница**: [sd-billing/overview](/docs/sd-billing/overview)
- **Раздел-источник**: Диаграмма архитектуры
...
## 03. Интеграция с sd-main и sd-cs {#d-03}

- **Тип**: `sequence`
- **Исходная страница**: [sd-billing/integration](/docs/sd-billing/integration)
- **Раздел-источник**: Интеграция с sd-main и sd-cs
...
## 04. Доменная модель sd-billing {#d-04}

- **Тип**: `er`
- **Исходная страница**: [sd-billing/domain-model](/docs/sd-billing/domain-model)
- **Раздел-источник**: Доменная модель sd-billing
...
- **Тип**: `sequence`
- **Исходная страница**: [sd-billing/balance-and-money-math](/docs/sd-billing/balance-and-money-math)
- **Раздел-источник**: Sequence
...
## 06. После изменения баланса — обновление лицензии {#d-06}

- **Тип**: `flowchart`
- **Исходная страница**: [sd-billing/balance-and-money-math](/docs/sd-billing/balance-and-money-math)
- **Раздел-источник**: После изменения баланса — обновление лицензии
...
## 07. Подписка и лицензирование {#d-07}

- **Тип**: `flowchart`
- **Исходная страница**: [sd-billing/subscription-flow](/docs/sd-billing/subscription-flow)
- **Раздел-источник**: Подписка и лицензирование
...
## 08. ERD (вид по форме) {#d-08}

- **Тип**: `er`
- **Исходная страница**: [sd-billing/data-scheme](/docs/sd-billing/data-scheme)
- **Раздел-источник**: ERD (вид по форме)
...
- **Тип**: `flowchart`
- **Исходная страница**: [sd-billing/cron-and-settlement](/docs/sd-billing/cron-and-settlement)
- **Раздел-источник**: Расчёты
...
## 10. Cron уведомлений {#d-10}

- **Тип**: `sequence`
- **Исходная страница**: [sd-billing/cron-and-settlement](/docs/sd-billing/cron-and-settlement)
- **Раздел-источник**: Cron уведомлений
...
## 11. Поток Click (каноничный) {#d-11}

- **Тип**: `sequence`
- **Исходная страница**: [sd-billing/payment-gateways](/docs/sd-billing/payment-gateways)
- **Раздел-источник**: Поток Click (каноничный)
